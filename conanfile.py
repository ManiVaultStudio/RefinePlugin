...
class RefinePluginConan(ConanFile):
    """Class to package RefinePlugin using conan
    ...
    topics = ("mv", "plugin", "view", "refine")
    url = "https://github.com/ManiVaultStudio/RefinePlugin"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/RefinePlugin")
        cmake.verbose = True
        return cmake
    ...
    def package(self):
        # Todo package the openblas and faiss along with the RefinePlugin
